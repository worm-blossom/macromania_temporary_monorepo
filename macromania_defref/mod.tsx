...
export type DefrefConfig = {
  ...
  /**
   * A function to tansform (usually wrap) the preview html.
...
>("ConfigDefref", () => ({
  ...
  const newValue: DefrefConfig = {
    ...
    wrapPreviews: update.wrapPreviews === undefined
      ? old.wrapPreviews
      : update.wrapPreviews,
  };
      ...
      fun={(ctx) => {
        ...
        if (!props.noPreview) {
          if (props.preview === undefined) {
            ...
            addScopeDeps(ctx);
            previewScopeWrapper(ctx, config.wrapPreviews!);
          } else {
            explicitPreviewExp = (
              <omnomnom>
                <PreviewScope wrapPreviews={config.wrapPreviews}>
                  {props.preview}
                  <impure
                    fun={(ctx) => {
                      registerPreview(ctx, {
